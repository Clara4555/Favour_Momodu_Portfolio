...
- Allow anon + authenticated to INSERT (anyone can send a contact message).
- No SELECT/UPDATE/DELETE for anon or authenticated — messages are write-only from the client.
*/
